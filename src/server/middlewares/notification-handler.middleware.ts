...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  ...
  'task.update.update': { roles: ['administrator', 'project-manager'], key: 'task', tenantPath: [], userPath: [] },
  'issue.resolve.update': { roles: ['administrator'], key: 'issue', tenantPath: [], userPath: [] },
};
